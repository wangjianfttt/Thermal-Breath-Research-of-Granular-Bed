...
PDF = ROOT / "nature_physics_extended_data_figures.pdf"
OUT_CSV = ROOT / "source_data" / "nature_physics_extended_data_visual_qa.csv"
SCALE = 1.35
INK_THRESHOLD = 245
...
def main() -> None:
    ...
    for page in range(pdf.pageCount()):
        ...
        rows.append(
            {
                "rendered_page": f"extended_data_page_{page + 1:02d}.png",
